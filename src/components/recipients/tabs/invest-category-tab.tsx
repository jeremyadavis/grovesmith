...
export function InvestCategoryTab({ recipient }: InvestCategoryTabProps) {
  ...
  const thresholdAmount = 50.00; // Default threshold
        ...
        <Card>
          <CardContent className="p-4">
            <div className="text-center">
              ...
              <p className="text-xl font-bold text-gray-900">{(dividendRate * 100).toFixed(1)}%</p>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            <div className="text-center">
              ...
              <p className="text-xl font-bold text-gray-900">${nextDividend.toFixed(2)}</p>
            </div>
          </CardContent>
        </Card>
        <Card>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="text-center">
              ...
              <p className="text-sm font-medium text-gray-600">Until Real Investing</p>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              ...
              <div className="text-right">
                <p className="text-sm text-gray-500">Based on current balance</p>
              </div>
            </div>
          </div>
        </CardContent>
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="p-4 bg-orange-50 rounded-lg">
              <h4 className="font-semibold text-orange-700 mb-2">Compound Growth</h4>
              <p className="text-sm text-gray-700">
                When you invest money, it grows over time. The more you invest and the longer you leave it, 
                the more it can grow through the power of compound interest.
              </p>
            </div>
            <div className="p-4 bg-blue-50 rounded-lg">
              <h4 className="font-semibold text-blue-700 mb-2">Dividend Simulation</h4>
              <p className="text-sm text-gray-700">
                Every dollar you invest earns a 5¢ dividend twice per month. This helps you see how 
                investments can grow over time.
              </p>
            </div>
            <div className="p-4 bg-green-50 rounded-lg">
              <h4 className="font-semibold text-green-700 mb-2">Real Investing</h4>
              <p className="text-sm text-gray-700">
                When your dividends reach $50, you can move to real stock investing with a UGMA/UTMA account!
              </p>
            </div>
          </div>
        </CardContent>
